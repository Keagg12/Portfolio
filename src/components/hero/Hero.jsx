        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="animate-in mb-8" style={{ color: 'var(--muted)', fontSize: 16, lineHeight: 1.7, maxWidth: 500, animationDelay: '0.3s' }}>
              B.Tech CSE student at Bharati Vidyapeeth (GGSIPU), building scalable frontends, diving deep into full-stack development, solving 200+ DSA problems, and moving toward ML Engineering.
            </p>
            ...
            <div className="flex gap-4 mt-8 animate-in" style={{ animationDelay: '0.5s' }}>
              ...
              <a href="https://github.com" target="_blank" rel="noreferrer" className="social-icon" style={{ color: 'var(--muted)', transition: 'color 0.3s', display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 13, textDecoration: 'none' }}>
